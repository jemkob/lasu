...
You have been offered provisional admission to Nigeria Certificate In Education Programme.
<p>&nbsp;</p><p>&nbsp;</p>
        ...
        <div id="home" class="tab-pane fade in active">
          ...
          <div class="col-md-12">
                ...
                <script>
                    ...
                    function makePaymentSchoolFees() {
                        var form = document.querySelector("#schoolfees-form");
                    ...
                    function makePaymentAcceptance() {
                        var form = document.querySelector("#acceptance-form");
                        var paymentEngine = RmPaymentEngine.init({
                            key: 'amVta29iQHlhaG9vLmNvbXw0MjUwODc0MHxlNjNiY2Y3ODEwZGRkMDMzZWQ4MTAxNjI0MWY4OWFjYTEwZmQ2YjQxN2EyZmRkNGVlNTg5NjVkZWQxYjliYjViM2ZmMjI1MDNkZmMzMjBlMjIxNGY5NDM0MzBiY2Q3OTRlMTNlODliMGUxMmE4NDNhNmVkMzE0MjQ2MjQzMjRkMQ==',
                            customerId: form.querySelector('input[name="email"]').value,
                            firstName: form.querySelector('input[name="firstName"]').value,
                    ...
                    function makePaymentSchoolFees2() {
                        var form = document.querySelector("#schoolfees2-form");
                        var paymentEngine = RmPaymentEngine.init({
                            key: 'amVta29iQHlhaG9vLmNvbXw0MjUwODc0MHxlNjNiY2Y3ODEwZGRkMDMzZWQ4MTAxNjI0MWY4OWFjYTEwZmQ2YjQxN2EyZmRkNGVlNTg5NjVkZWQxYjliYjViM2ZmMjI1MDNkZmMzMjBlMjIxNGY5NDM0MzBiY2Q3OTRlMTNlODliMGUxMmE4NDNhNmVkMzE0MjQ2MjQzMjRkMQ==',
                            customerId: form.querySelector('input[name="email"]').value,
                            firstName: form.querySelector('input[name="firstName"]').value,
                        ...
                        <div class="box-body">
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <input type="button" onclick="makePaymentAcceptance()" value="Pay" class="btn btn-success"/>
                                     </form>
                                        </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <input type="button" onclick="makePaymentSchoolFees()" value="Pay" class="btn btn-success"/>
                                       </form></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <input type="button" onclick="makePaymentSchoolFees2()" value="Pay" class="btn btn-success"/>
                                       </form></td>
                                    </tr>
                                </tbody>
                            </table>
