...
$results = DB::table('results')
        ...
        ->selectRaw('results.studentid as studentid, results.matricno as matricno, students.surname as surname, students.firstname as firstname, students.middlename as middlename, students.major as major, students.minor as minor, students.gender as gender, students.sor as state, students.facultyname as school, results.subjectcombinid as programid')
        ...
        ->select('results.studentid as studentid', 'results.ca as ca', 'results.exam as exam', 'subjects.SubjectValue as tnu', 'results.matricno as matricno', 'results.departmentid as departmentid', 'subjects.subjectcode as subjectcodeco', 'subjects.subjectvalue as subjectunitco', 'subjects.subjectunit as subjectvalueco', DB::raw('results.ca + results.exam as examca'))
        ...
        ->selectRaw('results.studentid as studentid, results.matricno as matricno, sum(tnu) as sum, sum(subjects.SubjectValue) as sum2')
        ->where('results.Level', 100)
        //->where('results.Semester', $semester01)
        ->where('results.SessionID', $session01-2)
        ->whereRaw('results.subjectcombinid in ('.$thesubcomb.')');
        ...
        ->leftjoin('departments', 'results.DepartmentID', '=', 'departments.DepartmantID')
        ->leftjoin('subjects', 'results.SubjectID', '=', 'subjects.SubjectID')
        ->selectRaw('results.studentid as studentid, results.matricno as matricno, sum(results.tnu) as sum, sum(subjects.SubjectValue) as sum2')
        ->where('results.Level', $level01)
        //->where('results.Semester', $semester01)
        ->where('results.SessionID', $session01)
        ->whereRaw('results.subjectcombinid in ('.$thesubcomb.')')
 ...
 */
        ...
        ->leftjoin('subjects', 'results.SubjectID', '=', 'subjects.SubjectID')
        ->select('results.studentid as studentid', 'results.matricno as matricno', 'subjects.subjectcode as subjectcodeco', 'subjects.subjectvalue as subjectunitco', 'subjects.subjectunit as subjectvalueco')
        ->where('results.Level', $level01)
        ->where('results.Semester', $semester01)
        ->where('results.SessionID', $session01)
        ->whereRaw('results.subjectcombinid in ('.$thesubcomb.')')
