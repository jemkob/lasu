   ...
   public function insert(Request $request){
    ...
    //   echo '<a href = "/insert">Click Here</a> to go back.';
      ...
      DB::table('students')->insert(
        ['surname' => $surname, 'firstname' => $firstname, 'middlename' => $othername, 'nationality' => $country, 'sor' => $state, 'lga' => $lga, 'email' => $email, 'phonenumber' => $phone, 'major' => $major, 'minor' => $minor, 'gender' => $gender, 'invoicenumber' => $invoice]
    );
