                     ...
                     <td >{{$grp[0]->surname}} {{$grp[0]->firstname}} {{$grp[0]->middlename}}  </td>
                      ...
                      <td>
                        ...
                        if ($calculate >= 70)  {$calculates = 5;}
                                elseif ($calculate >= 60 && $calculate <= 69)  {$calculates = 4; $gettnup = $gee->tnu;}
                                elseif ($calculate >= 50 && $calculate <= 59)  {$calculates = 3; $gettnup = $gee->tnu;}
                                elseif ($calculate >= 45 && $calculate <= 49)  {$calculates = 2; $gettnup = $gee->tnu;}
                                elseif ($calculate >= 40 && $calculate <= 44)  {$calculates = 1; $gettnup = $gee->tnu;}
