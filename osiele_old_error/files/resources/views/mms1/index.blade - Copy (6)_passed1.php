        ...
        {{-- {{$resultaddup}} --}}
                  ...
                  <table border="1" width="100%" class="table-responsive">
                    ...
                    <tr>
                      ...
                      <th colspan="4" style="text-align:center;">{{$deptcode1}}</th>
                      @if (count($results2) < 1) 
                      @else
                      <th colspan="4" style="text-align:center;">{{$deptcode2}}</th>
                      @endif
                      <th colspan="4" style="text-align:center;">{{$deptcode3}}</th>
                      <th colspan="4" style="text-align:center;">{{$deptcode4}}</th>
                      @if (!empty($results5) && count($results5) > 0) 
                      <th colspan="4" style="text-align:center;">TP</th>
                      @endif
