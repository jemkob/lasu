    ...
    <div class="box-body">
            <div class="row noprint">
                  ...
                  <table width="100%" border="0">
                    ...
                    <table>
                        <tr>
                        <th>MATRIC NO </th><td>{{$student->MatricNo}}</td>
                        </tr>
                        <tr>
                            <th>STUDENT NAME </th><td>{{$student->Surname}} {{$student->Firstname}} {{$student->Middlename}}</td>
                        </tr>
                        <tr>
                            <th>SUB/COM</th><td>{{$subcom->SubjectCombinName}}</td>
                        </tr>
                        <tr>
                            <th>LEVEL</th><td>{{$resultslip[0]->Level}}</td>
                        </tr>
                        <tr>
                            <td></td><td></td>
                        </tr>
                    ...
                    <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                      ...
                      <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="topbottomborder">COURSE TITLE</td>
                                <td class="topbottomborder">STATUS</td>
                                <td class="topbottomborder">UNIT</td>
                                <td class="topbottomborder">GRADE</td>
                                <td class="topbottomborder">SCORE</td>
                            </tr>
                            @if(count($passed1)>0)
                            @foreach ($passed1 as $co)
                            <tr>
                                <td class="topbottomborder"></td>
                            ...
                            <tr>
                                <td colspan="4" align="center" style="border-bottom: 1px solid #000; border-top: 1px solid #000; border-left: 1px solid #000;" class="auto-style5"><strong>Number of Courses Registered : </strong></td>
                      ...
                      <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                            ...
                            if (!isset($prevsummary) || $allsummary->dcode =='TP') {
                                $prevtcp = 0;
                                $prevtnu = 0;
                                $prevtnup = 0;
                                $prevcgpa = 0;
