                          ...
                          <table border="1" width="100%">
                              <tr> 
                                @foreach($resfiltered as $index=>$resfilt)
                                 <td style="width:47px" colspan="4"><strong>{{$resultaddup[$index]->subjectcodeco}} [{{$resultaddup[$index]->subjectunitco }}{{$resultaddup[$index]->subjectvalueco}}]</strong></td>
                          ...
                          @foreach($results as $index=>$result)
                              ...
                              <table border="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td>{{$resfilt->ca}}</td>
                                  <td>{{$resfilt->exam}}</td>
                                  <td>{{$resfilt->examca}}</td>
                                  <td>{{$resfilt->ca+$resfilt->exam}}</td>
                                  @endforeach
                                </tr>
                              </table></td>
