...
<div class="box">
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Edit Information {{Auth::user()}}</h3>
  </div>
  ...
  <div class="box-body">
        ...
        <form method="POST" action="student/editprofiles">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="surname" type="text" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" name="surname" value="{{$posts->Surname}}" required autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="firstname" type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" value="{{$posts->Firstname}}" required autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="othername" type="text" class="form-control{{ $errors->has('othername') ? ' is-invalid' : '' }}" name="othername" value="{{$posts->Middlename}}" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="country" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" name="country" value="{{$posts->Nationality}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="state" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" name="state" value="{{$posts->SOR}}">
                        <option value="{{$posts->SOR}}">{{$posts->SOR}}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="lga" type="text" class="form-control{{ $errors->has('lga') ? ' is-invalid' : '' }}" name="lga" value="{{$posts->LGA}}" required autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="subjectcomb" class="form-control{{ $errors->has('subjectcomb') ? ' is-invalid' : '' }}" name="state" value="{{$posts->Major}}/{{$posts->Minor}}">
            
                <option value="{{$posts->Major}}/{{$posts->Minor}}">{{$posts->Major}}/{{$posts->Minor}}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{$posts->Email}}" required>
            ...
            <div class="form-group row">
                    ...
                    <label for="lag" class=" col-form-label text-md-right">{{ __('LGA') }}</label>
