        ...
        $('#level').on('change', function(e){
          ...
          $.get('/curriculumcourses?level=' + level + '&combination='+combination+'&sessions='+session,function(data) {
            ...
            $.each(data, function(index, coursesObj){
              $('table#courses').append('<tr><td scope="col" width="5px"> <input type="checkbox" name="course[]" id="'+coursesObj.SubjectCode+'" value="'+coursesObj.SubjectID+'"></td><td><label for="'+coursesObj.SubjectCode+'">'+coursesObj.SubjectCode+'</label></td><td>'+coursesObj.SubjectName+'</td> <td>'+coursesObj.SubjectValue+'</td><td>'+coursesObj.SubjectUnit+'</td></tr>');
            })
          });
        });
