...
<div class="box">
  <div class="box-header with-border noprint">
    <h3 class="box-title">Mark Master Sheet</h3>
  </div>
    <div class="box-body">
            <div class="row noprint">
                    <div class="col-sm-4">
                      <form action="{{url('markmastersheet/search')}}" method="post">
                        {{csrf_field()}}
                  ...
                  {{-- Header --}}
                   ...
                   <div class="noprint">
                     <br><br>
                    <hr>
                   <form action="{{url('markmastersheet/print')}}" method="post">
                    {{csrf_field()}}
                  ...
                  <table width="100%">
                      ...
                      <tr>
                      <td style="font-size:11px">Date printed: {{date_format(now(),"d/m/Y H:i:s")}}</td>
                      </tr>
                    </table>
                  ...
                  //$keyed = $addup->groupby('matricno')->keyby('subjectcodeco');
                   ...
                   $header = collect($compulsorycourses)->sortBy('matricno')->sortBy('subjectcodeco')->groupby('matricno')->first();
                    ...
                    //  if($gee->subjectcodeco == $grp[$key]->subjectcodeco){
                     ...
                     <?php
                        ...
                        $actualcourse->first();
                          ...
                          ?>
                      <td>
                        @foreach($actualcourse as $actual)
                        {{$actual->examca}}
                        @endforeach
                      ...
                      <?php
                        ...
                        <td style="width:300px">
                            <?php 
                            $rescollection = collect($resultaddup);
                              $resfiltered = $rescollection->where('matricno', $themat)->sortKeys()->unique('subjectcodeco');
                              $resfiltered->all();
                            // dump($resfiltered);
