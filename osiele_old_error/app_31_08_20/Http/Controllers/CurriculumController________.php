...
class CurriculumController extends Controller
{
    ...
    public function curriculumcourses(Request $request){
        ...
        // ->leftjoin('allcombinedcourses', 'subjects.subjectid','=','allcombinedcourses.subjectid')
        ->whereraw('SubjectLevel='.$level.' and sessionid = 8 and subjectcombineid='.$combinationid.' and (subjectcode like "'.$major.'%" or SubjectCode like "'.$minor.'%" or SubjectCode like "gse%" or SubjectCode like "edu%" or SubjectCode like "esa%")')
        ->pluck('subjectid');
