                ...
                <div class="card-body">
                    <form method="POST" action="/create">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jamb" type="text" class="form-control{{ $errors->has('JAMB No.') ? ' is-invalid' : '' }}" name="jamb" value="{{ old('jamb') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="country" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" name="country" value="{{ old('country') }}" required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="state" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" name="state" value="{{ old('state') }}" required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lga" type="text" class="form-control{{ $errors->has('lga') ? ' is-invalid' : '' }}" name="lga" value="{{ old('lga') }}" required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="subjectcomb" class="form-control{{ $errors->has('subjectcomb') ? ' is-invalid' : '' }}" name="state" value="{{ old('subjectcomb') }}" required="required">
                        
                            @foreach($combinations as $comb)
                                <option value="{{$comb->SubjectCombinName}}">{{$comb->SubjectCombinName}}</option>
                            @endforeach
