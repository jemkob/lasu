...
<div class="box">
  <div class="box-header with-border">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-sm-4">
          <form action="{{url('courseregistration/search')}}" method="post">
...
@if(isset($courseview))
    ...
    <form name="form1" method="post" action="{{url('courseregistration/deletecourse')}}">
        ...
        <table class="table table-striped" style="text-transform:uppercase;" width="70%">
              ...
              <a href='#' onclick="CheckAll()" class="btn btn-danger">Check All</a>
              <span>
...
<script>
    function CheckAll() {
        var x = document.getElementsByName("resultid[]");
        var i;
