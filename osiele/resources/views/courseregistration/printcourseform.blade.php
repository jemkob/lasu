  ...
  <div class="box-header with-border noprint">
    ...
    <div class="box-body">
      <div class="row noprint">
        <div class="col-sm-4">
          <form action="{{url('courseregistration/print')}}" method="post">
...
@if(isset($courseview) || isset($courseview1))
    @if (count($courseview) < 1 && count($courseview1) < 1)
  ...
  <table style="text-transform:uppercase">
      <tr>
          ...
          <td>@if(!empty($studentimage->StudentImage))
      ...
      <tr>
          ...
          <td class="auto-style7">LEVEL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              @if($students->Level == 400) 300+ @elseif($students->Level == 500) 300++ @else {{$students->Level }} @endif</td>
      </tr>
  ...
  <table style="width: 100%; margin-top: 5px; border-top: 1px solid #aaa; border-bottom: 1px solid #aaa; font-size: x-small; font-weight: 700; text-transform:uppercase;" border="0" cellspacing="0">
     ...
     @foreach($courseview as $index =>$post)
                  ...
                  <tr>
                      <td style="border-bottom: 1px solid #aaa; border-top: 1px solid #aaa; border-left: 1px solid #aaa; border-right: 1px solid #aaa;">{{$loop->index+1}}</td>
