...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Student Manager | New Curriculum</h3>
  ...
  <div style="padding-left:10px; padding-right:10px;">
    ...
    <div style="float:left;">
        <div class="col-md-6">
            <div class="row">
              <form action="{{url('studentmanager/importcur')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="file" name="coursefile" id="coursefile" required="required"/>
