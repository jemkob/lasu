            ...
            <div class="row noprint">
                  ...
                  <tr>   
                    ...
                    <th></th>
                     ...
                     <th colspan="3">{{$gee->subjectcodeco}} [{{$gee->subjectunitco}} {{$gee->subjectvalueco}}]</th>
                      @endforeach
                  ...
                  @dump($grp) --}}
                    ...
                    <?php if(!isset($grp[$key]->subjectcodeco)) { 
                      ...
                      <td>{{$actualcourse[0]->ca}}</td>
                      <td>{{$actualcourse[0]->exam}}</td>
                      <td>{{$actualcourse[0]->examca}}</td>
                      @else
                      <td></td>
                      <td></td>
                      <td></td>
