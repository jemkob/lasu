    ...
    <div class="box-body">
            <div class="row noprint">
                  ...
                  <div class="table-responsive">
                   <table width="1500px" border="2" style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" class="table-responsive">
                  <tr>   
                  ...
                  <tr>
                   ...
                   @foreach($grouped->sortby('matricno') as $index=>$grp)
                   <tr>
                     ...
                     <td >{{$grp[0]->surname}} {{$grp[0]->firstname}} {{$grp[0]->middlename}}  </td>
                      ...
                      <?php
                              ...
                              <td style="width:300px">
                                  ...
                                  $set1='';
                                  $set2='';
                                  $set1 = collect($compulsorycourses)->where('subjectvalueco', 'C'); // Contents omitted for brevity
