  ...
  <div class="box-header with-border noprint">
    ...
    <div class="box-body">
            <div class="row noprint">
                    <div class="col-sm-4">
                      <form action="{{url('summarypassed/search')}}" method="post">
                        {{csrf_field()}}
        ...
        {{-- {{$resultaddup}} --}}
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
                          <tr>
                            ...
                            <td width="42" scope="col">@if($thisession->SessionYear > 300) 300+ @else {{$thisession->SessionYear}} @endif</td>
                  ...
                  <table border="1" width="100%" class="table-responsive" id="passedRows">
                    <thead>
                    <tr>
                      <th rowspan="2">S/N</th>
