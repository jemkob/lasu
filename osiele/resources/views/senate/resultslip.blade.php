  ...
  <div class="box-header with-border noprint">
    ...
    <div class="box-body" style="text-transform:uppercase;">
            <div class="row noprint">
                  ...
                  <form action="printcount"></form>
                  <button type="submit" onclick="printvisible()" class="noprint btn btn-success">
                    <i class="fa fa-fw fa-print"></i>
                    Print Resultslip</button>
                    <div id="printcount"></div>
                  <table width="100%" border="0"id="biodata" style="text-transform:uppercase;visibility:hidden;">
                      <tr>
                    ...
                    <table cellspacing="10">
                      ...
                      <tr>
                          <th>LEVEL</th>
                          <th>&nbsp;</th>
                          <td>@if($resultslip[0]->Level > 300) 300+ @else {{$resultslip[0]->Level}} @endif</td>
                      </tr>
                      <tr>
                          <td></td>
                          <td></td>
                    ...
                    <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="topbottomborder">{{$results->TNU}}</td>
                      ...
                      <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                        ...
                        <?php
                            ...
                            $set1='';
                            $set2='';
                            $set1 = collect($compulsorycourses)->where('subjectlevel', $resultslip[0]->Level)->where('semester', $resultslip[0]->Semester); // Contents omitted for brevity
                      ...
                      <table style="width: 100%; margin-top: 5px; border-top: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; font-size: 12px;" border="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                {{-- Prev Summary --}}
                            <?php
                            /* if ($allsummary->dcode =='TP' $resultslip[0]->Level == 300 && $resultslip[0]->Semester==1) {
                                $prevtcp = 0;
                                $prevtnu = 0;
                                $prevtnup = 0;
                                $prevcgpa = 0;
                          ...
                          // }
                            ...
                            $resfiltered = $thesummary->where('deptname', 'Teaching Practice');
                            } else { */
...
function printvisible(){
  ...
  $.ajax({
            url: '<?php echo e(url('/printcount')); ?>',
            success: function(response)
            {
                jQuery('#printcount').html(response);
            }
        });
}
