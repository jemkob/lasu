            ...
            <div class="row noprint">
                  ...
                  <table border="0" style="width: 100%; margin-top: 5px; font-size: 12px; font-family:'New Times Roman', serif;">
                    ...
                    <tr style="height: 2.5px;"><td colspan="7" style="border-top: 2px dotted #000; height: 2.5px;"></td></tr>
                            ...
                            $firstsem = collect($academicstanding)->where('Level', $thelevel)->where('Semester', 1)->where('csession', $levels->SessionID)->all();
                            ?>
                            @if(count($firstsem) > 0)
                            ...
                            <tr>
                                ...
                                <td valign="top">{{$results->CA}}</td>
                                <td valign="top">{{$results->EXAM}}</td>
                                <td align="center" valign="top">{{$results->aSubjectUnit}}</td>
                                <td align="center" valign="top">{{$results->aSubjectValue}}</td>
                          ...
                          <?php
                          $secondsem = collect($academicstanding)->where('Level', $thelevel)->where('Semester', 2)->where('csession', $levels->SessionID)->all();
