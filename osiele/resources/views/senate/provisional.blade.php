...
<div class="box">
  ...
  <div class="box-header with-border noprint">
    <h3 class="box-title">Provisional Academic Standing</h3>
  </div>
    <div class="box-body">
  ...
  <div class="row noprint">
    <div class="col-sm-4">
      <form action="{{url('senate/provisional')}}" method="post">
        {{csrf_field()}}
...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><h4>STUDENT PROVISIONAL RESULTS</h4></td>
    <th>&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
  <tr>
