...
class Mms1AkokaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('mms1.akoka')->with('faculties', $faculties)->with('sessions', $sessions);
     }
